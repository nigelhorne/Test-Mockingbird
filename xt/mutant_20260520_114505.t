...
# --- SURVIVOR: NUM_BOUNDARY_467_37_!= (HIGH) line 467 in mock_scoped() ---
...
#   Numeric boundary flip >= to <=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_467_37_!= line 467 in mock_scoped()';
    ...
    fail('NUM_BOUNDARY_467_37_!=: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_478_17_> (HIGH) line 478 in mock_scoped() ---
...
#   Numeric boundary flip == to !=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_478_17_> line 478 in mock_scoped()';
    # Suggested boundary values to test: 4, 5, 6
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 478 in mock_scoped() to detect the mutant
    fail('NUM_BOUNDARY_478_17_>: replace with real assertion');
}
