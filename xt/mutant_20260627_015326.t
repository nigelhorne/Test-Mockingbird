...
# --- SURVIVOR: NUM_BOUNDARY_467_17_> (HIGH) line 467 in mock_scoped() ---
...
#   Numeric boundary flip == to !=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_467_17_> line 467 in mock_scoped()';
    ...
    # TODO: exercise line 467 in mock_scoped() to detect the mutant
    fail('NUM_BOUNDARY_467_17_>: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_478_37_!= (HIGH) line 478 in mock_scoped() ---
...
#   Numeric boundary flip >= to <=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_478_37_!= line 478 in mock_scoped()';
    # Suggested boundary values to test: 4, 5, 6
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 478 in mock_scoped() to detect the mutant
    fail('NUM_BOUNDARY_478_37_!=: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_615_3 (MEDIUM) line 615 in spy() ---
# Source:  return $orig->(@_);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_615_3 line 615 in spy()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 615 in spy() to detect the mutant
    fail('BOOL_NEGATE_615_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_825_2 (MEDIUM) line 825 in mock_return() ---
# Source:  return mock $target => $code;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_825_2 line 825 in mock_return()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 825 in mock_return() to detect the mutant
    fail('BOOL_NEGATE_825_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_868_2 (MEDIUM) line 868 in mock_exception() ---
# Source:  return mock($target, $code);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_868_2 line 868 in mock_exception()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 868 in mock_exception() to detect the mutant
    fail('BOOL_NEGATE_868_2: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_911_30_!= (HIGH) line 911 in mock_sequence() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_911_30_!= line 911 in mock_sequence()';
    # Suggested boundary values to test: 0, 1, 2
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 911 in mock_sequence() to detect the mutant
    fail('NUM_BOUNDARY_911_30_!=: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_912_3 (MEDIUM) line 912 in mock_sequence() ---
# Source:  return shift @queue;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_912_3 line 912 in mock_sequence()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 912 in mock_sequence() to detect the mutant
    fail('BOOL_NEGATE_912_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_917_2 (MEDIUM) line 917 in mock_sequence() ---
# Source:  return mock($target, $code);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_917_2 line 917 in mock_sequence()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 917 in mock_sequence() to detect the mutant
    fail('BOOL_NEGATE_917_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_978_2 (MEDIUM) line 978 in mock_once() ---
# Source:  return mock $target => $wrapper;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_978_2 line 978 in mock_once()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 978 in mock_once() to detect the mutant
    fail('BOOL_NEGATE_978_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_1017_3 (MEDIUM) line 1017 in restore() ---
# Source:  if (defined $prev) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1017_3 line 1017 in restore()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 1017 in restore() to detect the mutant
    fail('COND_INV_1017_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1163_2 (MEDIUM) line 1163 in diagnose_mocks_pretty() ---
# Source:  return join "\n", @out;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1163_2 line 1163 in diagnose_mocks_pretty()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 1163 in diagnose_mocks_pretty() to detect the mutant
    fail('BOOL_NEGATE_1163_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1191_2 (MEDIUM) line 1191 in _get_prototype() ---
# Source:  return prototype($code);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1191_2 line 1191 in _get_prototype()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 1191 in _get_prototype() to detect the mutant
    fail('BOOL_NEGATE_1191_2: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_615_3 line 615 in spy() ---
# Source:  return $orig->(@_);
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_615_3: add assertion here');

# --- LOW HINT: RETURN_UNDEF_825_2 line 825 in mock_return() ---
# Source:  return mock $target => $code;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_825_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_868_2 line 868 in mock_exception() ---
# Source:  return mock($target, $code);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_868_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_911_3 line 911 in mock_sequence() ---
# Source:  return $queue[0] if @queue == 1;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_911_3: add assertion here');

# --- LOW HINT: RETURN_UNDEF_912_3 line 912 in mock_sequence() ---
# Source:  return shift @queue;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_912_3: add assertion here');

# --- LOW HINT: RETURN_UNDEF_917_2 line 917 in mock_sequence() ---
# Source:  return mock($target, $code);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_917_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_978_2 line 978 in mock_once() ---
# Source:  return mock $target => $wrapper;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1163_2 line 1163 in diagnose_mocks_pretty() ---
# Source:  return join "\n", @out;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_1163_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_1191_2 line 1191 in _get_prototype() ---
# Source:  return prototype($code);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- SURVIVOR: BOOL_NEGATE_1027_3 (MEDIUM) line 1027 in _parse_timestamp() ---
# Source:  return timegm($6,$5,$4,$3,$2-1,$1);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1027_3 line 1027 in _parse_timestamp()';
    # NOTE: Test::Mockingbird::TimeTravel has no constructor — call class methods directly.
    # e.g. my $result = Test::Mockingbird::TimeTravel->method(...);
    # TODO: exercise line 1027 in _parse_timestamp() to detect the mutant
    fail('BOOL_NEGATE_1027_3: replace with real assertion');
}
...
# --- SURVIVOR: BOOL_NEGATE_1033_3 (MEDIUM) line 1033 in _parse_timestamp() ---
# Source:  return timegm($6,$5,$4,$3,$2-1,$1);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1033_3 line 1033 in _parse_timestamp()';
    # NOTE: Test::Mockingbird::TimeTravel has no constructor — call class methods directly.
    # e.g. my $result = Test::Mockingbird::TimeTravel->method(...);
    # TODO: exercise line 1033 in _parse_timestamp() to detect the mutant
    fail('BOOL_NEGATE_1033_3: replace with real assertion');
}
...
# --- SURVIVOR: BOOL_NEGATE_1038_3 (MEDIUM) line 1038 in _parse_timestamp() ---
# Source:  return timegm(0,0,0,$3,$2-1,$1);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1038_3 line 1038 in _parse_timestamp()';
    # NOTE: Test::Mockingbird::TimeTravel has no constructor — call class methods directly.
    # e.g. my $result = Test::Mockingbird::TimeTravel->method(...);
    # TODO: exercise line 1038 in _parse_timestamp() to detect the mutant
    fail('BOOL_NEGATE_1038_3: replace with real assertion');
}
...
# --- LOW HINT: RETURN_UNDEF_1027_3 line 1027 in _parse_timestamp() ---
# Source:  return timegm($6,$5,$4,$3,$2-1,$1);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Test::Mockingbird::TimeTravel has no constructor — call class methods directly.
# e.g. my $result = Test::Mockingbird::TimeTravel->method(...);
# ok($result, 'RETURN_UNDEF_1027_3: add assertion here');

# --- LOW HINT: RETURN_UNDEF_1033_3 line 1033 in _parse_timestamp() ---
# Source:  return timegm($6,$5,$4,$3,$2-1,$1);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Test::Mockingbird::TimeTravel has no constructor — call class methods directly.
# e.g. my $result = Test::Mockingbird::TimeTravel->method(...);
# ok($result, 'RETURN_UNDEF_1033_3: add assertion here');

# --- LOW HINT: RETURN_UNDEF_1038_3 line 1038 in _parse_timestamp() ---
# Source:  return timegm(0,0,0,$3,$2-1,$1);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Test::Mockingbird::TimeTravel has no constructor — call class methods directly.
# e.g. my $result = Test::Mockingbird::TimeTravel->method(...);
# ok($result, 'RETURN_UNDEF_1038_3: add assertion here');
