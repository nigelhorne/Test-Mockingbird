...
# --- SURVIVOR: BOOL_NEGATE_928_2 (MEDIUM) line 928 in mock_return() ---
# Source:  return mock $target => $code;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_928_2 line 928 in mock_return()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 928 in mock_return() to detect the mutant
    fail('BOOL_NEGATE_928_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_971_2 (MEDIUM) line 971 in mock_exception() ---
# Source:  return mock($target, $code);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_971_2 line 971 in mock_exception()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 971 in mock_exception() to detect the mutant
    fail('BOOL_NEGATE_971_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1020_2 (MEDIUM) line 1020 in mock_sequence() ---
# Source:  return mock($target, $code);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1020_2 line 1020 in mock_sequence()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 1020 in mock_sequence() to detect the mutant
    fail('BOOL_NEGATE_1020_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1081_2 (MEDIUM) line 1081 in mock_once() ---
# Source:  return mock $target => $wrapper;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1081_2 line 1081 in mock_once()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 1081 in mock_once() to detect the mutant
    fail('BOOL_NEGATE_1081_2: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_928_2 line 928 in mock_return() ---
# Source:  return mock $target => $code;
...
# --- LOW HINT: RETURN_UNDEF_971_2 line 971 in mock_exception() ---
# Source:  return mock($target, $code);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1020_2 line 1020 in mock_sequence() ---
# Source:  return mock($target, $code);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1081_2 line 1081 in mock_once() ---
# Source:  return mock $target => $wrapper;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
