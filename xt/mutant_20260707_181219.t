...
# --- SURVIVOR: BOOL_NEGATE_915_2 (MEDIUM) line 915 in mock_return() ---
# Source:  return mock $target => $code;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_915_2 line 915 in mock_return()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 915 in mock_return() to detect the mutant
    fail('BOOL_NEGATE_915_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_958_2 (MEDIUM) line 958 in mock_exception() ---
# Source:  return mock($target, $code);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_958_2 line 958 in mock_exception()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 958 in mock_exception() to detect the mutant
    fail('BOOL_NEGATE_958_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1007_2 (MEDIUM) line 1007 in mock_sequence() ---
# Source:  return mock($target, $code);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1007_2 line 1007 in mock_sequence()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 1007 in mock_sequence() to detect the mutant
    fail('BOOL_NEGATE_1007_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1068_2 (MEDIUM) line 1068 in mock_once() ---
# Source:  return mock $target => $wrapper;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1068_2 line 1068 in mock_once()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 1068 in mock_once() to detect the mutant
    fail('BOOL_NEGATE_1068_2: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_915_2 line 915 in mock_return() ---
# Source:  return mock $target => $code;
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_915_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_958_2 line 958 in mock_exception() ---
# Source:  return mock($target, $code);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_958_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_1007_2 line 1007 in mock_sequence() ---
# Source:  return mock($target, $code);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Test::Mockingbird requires constructor arguments, add them here.
# my $obj = new_ok('Test::Mockingbird');
# ok($obj->..., 'RETURN_UNDEF_1007_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_1068_2 line 1068 in mock_once() ---
# Source:  return mock $target => $wrapper;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
