...
# --- SURVIVOR: COND_INV_733_2 (MEDIUM) line 733 in spy() ---
# Source:  if (defined $orig_proto) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_733_2 line 733 in spy()';
    # NOTE: new() called with no arguments as a starting point.
    # If Test::Mockingbird requires constructor arguments, add them here.
    my $obj = new_ok('Test::Mockingbird');
    # TODO: exercise line 733 in spy() to detect the mutant
    fail('COND_INV_733_2: replace with real assertion');
}
